...
export const NOTIFICATIONS = [
  {
    id: 'n1',
    text: 'У нас для Вас є пропозиція!',
    time: 'сьогодні 20:57',
    read: false,
    detail: 'Ми підібрали для вас нові оголошення про оренду, що відповідають вашим фільтрам. Перегляньте їх на головній сторінці!',
    icon: 'info',
  },
  {
    id: 'n2',
    ...
    time: 'сьогодні 18:30',
    read: false,
    detail: 'Ми оновили застосунок RENTO. Тепер пошук сусідів став ще зручнішим, а барахолка отримала нові категорії товарів.',
    icon: 'info',
  },
  {
    id: 'n3',
    text: 'Новий відгук про вас',
    time: 'вчора 14:12',
    read: true,
    detail: 'Орендодавець Надія Юхимчук залишила вам відгук зі словами подяки. Ваш рейтинг зріс до 4.9 ⭐',
    icon: 'star',
  },
  {
    id: 'n4',
    text: 'Ваше житло додано до обраних',
    time: 'вчора 09:44',
    read: true,
    detail: 'Користувач додав ваше оголошення на вул. Роксоляни до списку обраних. Можливо, незабаром він звʼяжеться з вами!',
    icon: 'heart',
  },
  {
    id: 'n5',
    text: 'Нове повідомлення від Віктора',
    time: '2 дні тому',
    read: true,
    detail: 'Віктор надіслав вам повідомлення щодо оренди. Перейдіть у розділ Повідомлення, щоб відповісти.',
    icon: 'message',
  },
];
