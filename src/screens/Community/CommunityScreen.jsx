...
const RoommateStubScreen = ({ roommate, onBack }) => (
  <div className="relative w-full h-full flex flex-col font-montserrat bg-[#f1f2f6]">
    ...
    <div className="flex flex-col items-center justify-center flex-1 gap-4 px-6">
      <img src={roommate.avatar}
        className="w-24 h-24 rounded-full object-cover shadow-lg" alt={roommate.name} />
      ...
      <p className="text-[14px] text-[#4b5b7e] text-center mt-2">{roommate.description}</p>
...
const AllRoommatesStub = ({ onBack }) => (
  <div className="relative w-full h-full flex flex-col font-montserrat bg-[#f1f2f6]">
    <div className="flex items-center justify-between px-6 pt-14 pb-4">
      ...
      <span className="font-bold text-[22px] text-[#012A81]">Всі сусіди</span>
      <div className="w-9" />
    </div>
    <div className="flex flex-col items-center justify-center flex-1 gap-3 px-6">
      <div className="text-[48px]">👥</div>
      <p className="font-bold text-[18px] text-[#012A81] text-center">
        Повний список сусідів
      </p>
      <p className="text-[13px] text-[#718096] text-center">
        Розширений пошук та фільтрація — скоро
      </p>
    </div>
  </div>
);
